...
function renderTask(task) {
  ...
  if (task.completed) {
    lists.style.cssText = "background-color: white;"
    listsText.style.cssText = "text-decoration: line-through; font-size: 13px; font-weight: bold";
    timestamp.style.cssText = "text-decoration: line-through; font-weight: bold";
  }
  liscont.style.cssText = "display: flex; width: 100%; justify-content: flex-end;";
  ...
  CheckBox.onclick = function () {
    ...
    if (CheckBox.checked) {
      ...
      listsText.style.cssText = "text-decoration: none; font-size: 13px; font-weight: bold";
